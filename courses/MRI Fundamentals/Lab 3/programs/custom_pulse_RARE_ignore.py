...
PARDEF = [
    ...
    ParDef('a_90', float, 0, unit=''),
    ParDef('t_90', float, 32e-6, unit='s'),
    ParDef('shape_90', float_array, [1], unit=''),
    ParDef('f_slice_offset', float, 0, unit='Hz'),
    ParDef('a_180', float, 0, unit=''),
    ParDef('t_180', float, 32e-6, unit='s'),
    ParDef('t_inv', float, 1e-3, unit='s'),
    ParDef('t_dw', float, 1e-6, unit='s'),
    ParDef('n_samples', int, 320, unit=''),
    ParDef('t_read', float, 320e-6, unit='s'),
    ParDef('t_phase', float, 160e-6, unit='s'),
    ParDef('n_phase_1', int, 32, unit=''),
    ParDef('n_phase_2', int, 32, unit=''),
    ParDef('n_ETL', int, 0, unit=''),
    ...
    ParDef('n_grad_ramp', int, 10, unit=''),
