...
PARDEF = [
    ...
    ParDef('t_dw', float, 10e-6, min=0.1e-6, max=80e-6),
    ParDef('n_samples', int, 1000),
    ParDef('t_echo', float, 500e-6),
    ParDef('n_echo', int, 16),
...
def main(par: ParameterSet):
    ...
    t_180_180 = par.t_echo - par.t_180 # time delay between successive 180 pulses
    
    # calculate time for acquisition to finish after final 180 pulse
    t_finish = t_acq - par.t_90 - t_90_180 - par.n_echo*(par.t_180+t_180_180)
    if t_finish < 0:
        t_finish = 0
